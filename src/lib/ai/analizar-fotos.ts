...
export async function analizarFotosCapilares(
  ...
  for (const foto of fotos) {
    content.push({ type: "text", text: ANGULOS[foto.angulo] });
    content.push({
      type: "image",
  ...
  content.push({
    type: "text",
    text: "Analiza estas 5 fotos según las reglas indicadas y responde solo con el JSON.",
  });
