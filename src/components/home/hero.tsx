...
export function Hero() {
  return (
    <section className="mx-auto max-w-[1600px] px-6 pt-2.5 pb-10 sm:py-[41px]">
      <div className="grid items-center gap-10 lg:grid-cols-[0.85fr_1.15fr] lg:gap-6">
        ...
        <div className="relative order-1 -mx-6 aspect-[1140/894] w-[calc(100%+3rem)] sm:mx-auto sm:w-full sm:max-w-[840px] lg:order-2">
          <Image
