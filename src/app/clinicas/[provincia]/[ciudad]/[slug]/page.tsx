      ...
      <div className="mx-auto grid max-w-[1600px] gap-10 px-6 py-10 lg:grid-cols-[1fr_360px]">
        <div>
          <div className="flex flex-wrap items-start justify-between gap-3">
            <div className="flex items-start gap-4">
              {clinic.logo_url && (
                <div className="relative h-14 w-14 shrink-0 overflow-hidden rounded-full border border-line bg-white shadow-sm">
                  <Image
                    src={clinic.logo_url}
                    alt=""
                    fill
        ...
        <div className="flex flex-col gap-6">
          ...
          <Link
            ...
            className="press mt-4 inline-block rounded-full bg-gradient-to-r from-yellow to-orange px-5 py-2.5 text-sm font-bold text-teal-dark shadow-md shadow-orange/20 transition hover:opacity-90"
          >
            Pedir presupuesto →
          </Link>
